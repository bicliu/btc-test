...
void TxToUniv_add(const CTransaction& tx, const uint256& hashBlock, UniValue& entry, bool include_hex, int serialize_flags)
{
...
void TxToJSON(const CTransaction& tx, const uint256 hashBlock, UniValue& entry)
{
    ...
    TxToUniv_add(tx, uint256(), entry, true, RPCSerializationFlags());
